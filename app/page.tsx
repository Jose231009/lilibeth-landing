...
function WAFloat() {
  return (
    ...
    >
      <svg width="26" height="26" viewBox="0 0 24 24" fill="#1C1208">
...
function Footer() {
  return (
    <footer style={{
      ...
      <p style={{ fontSize: '12px', color: 'rgba(28,18,8,0.25)', lineHeight: 1.8 }}>
        © 2026 Lilibeth Paris · Todos los derechos reservados
      </p>
      <p style={{ fontSize: '12px', color: 'rgba(28,18,8,0.22)', marginTop: '6px' }}>
        <a href="/privacidad" style={{ color: 'rgba(28,18,8,0.4)', textDecoration: 'underline', marginRight: '16px' }}>
          Política de Privacidad
        </a>
        <a href="/privacidad#aviso-legal" style={{ color: 'rgba(28,18,8,0.4)', textDecoration: 'underline' }}>
          Aviso Legal
        </a>
      </p>
      <p style={{ fontSize: '11px', color: 'rgba(28,18,8,0.15)', marginTop: '10px', maxWidth: '560px', margin: '10px auto 0', lineHeight: 1.7 }}>
